...
void Page_Load(Object sender, EventArgs e)
{
    ...
    if (btnet.Util.get_setting("EnableMobile", "0") == "0") {
        Response.Write("TDSS Bugs Tracker EnableMobile is not set to 1 in Web.config");
        Response.End();
    }
    ...
    else
    {
        ...
        titl.InnerText = btnet.Util.get_setting("AppTitle", "TDSS Bugs Tracker") + " - Update";
        my_header.InnerText = titl.InnerText;
...
<html> 
<head> 
<title id=titl runat=server>TDSS Bugs Tracker Edit</title> 
...
<div class="page" data-role="page" data-cache="never">
	...
	<div data-role="header">
		<h1 id=my_header runat=server>TDSS Bugs Tracker Edit</h1>
	</div><!-- /header -->
